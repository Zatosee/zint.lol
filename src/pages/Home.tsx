...
export default function Home() {
  ...
  <main className="max-w-[1200px] mx-auto px-6">
    {/* BANNER */}
    <section
      className="flex flex-col items-center justify-center text-center bg-cover bg-center py-24"
    ...
    <section className="bg-[#121827] p-6 text-sm rounded-md my-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[0, 1].map((tableIndex) => (
          <table key={tableIndex} className="w-full text-left border border-gray-700 rounded-md overflow-hidden">
